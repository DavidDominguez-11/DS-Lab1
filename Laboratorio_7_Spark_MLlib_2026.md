...
**NOTA**: Estos conteos corresponden a los archivos proporcionados **antes** de aplicar filtros.
...
|---|---|
| I de 2025 | 2 |
| II de 2025 | 3 y, en 175 registros, 2 |
| III de 2025 | 4 |
| IV de 2025 | 5 |
| I de 2026 | 6 |

Cree las columnas `periodo_archivo`, `anio_archivo` y `trimestre_calendario` a partir del archivo de procedencia. Por ejemplo, el archivo de I de 2025 deberá identificarse como `2025T1`, año 2025 y trimestre calendario 1.
...
Para los modelos supervisados utilizará exactamente seis predictores: `edad`, `antiguedad`, `horas_semanales`, `nivel_educativo`, `categoria_ocupacional` y `dominio`.
